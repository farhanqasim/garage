...
{
    /**
     * Ensure car_wash_jobs has customer_id and customer_car_id (add if missing).
     * Drops customer_name, vehicle_no, mobile only if they exist.
     */
    ...
    public function down(): void
    {
        Schema::table('car_wash_jobs', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('car_wash_jobs', 'customer_car_id')) {
                ...
                $table->dropColumn('customer_car_id');
            }
        });
        Schema::table('car_wash_jobs', function (Blueprint $table) {
            if (!Schema::hasColumn('car_wash_jobs', 'customer_name')) {
