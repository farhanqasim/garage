                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group mt-2">
                                            <form action="{{ route('update.companies.status', $item->id) }}" method="POST"
                                                class="status-form">
                                                @csrf
                                ...
                                <div class="modal fade" id="edit-category{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update.companies', $item->id) }}" method="post"
    ...
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('post.companies') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="categoryname" class="col-form-label">Name:</label>
