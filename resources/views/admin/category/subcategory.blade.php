@extends('layouts.app')
@section('title', __('SubCategory List'))
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h2 class="fw-bold">SubCategory</h2>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($subcategories as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <img src='{{ asset($item->image) }}' alt={{ $item->name }} width="50px" height="50px"></td>
                                    <td>
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="p-2" href="{{ route('delete.category', $item->id) }}">
                                ...
                                <div class="modal fade" id="edit-category{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update.subcategory',$item->id) }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="categoryname" class="col-form-label">Name:</label>
                                                    <input type="text" class="form-control" name="name" value="{{ $item->name }}" id="categoryname">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($categories as $items)
                                                        <option value="{{ $items->id }}"
                                                            {{ $items->id == $item->parent_id ? 'selected' : '' }}>
                                                            {{ $items->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
    ...
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <form action="{{ route('post.sub.category') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                    <div class="form-group">
                        <label for="categoryname" class="col-form-label">Name:</label>
