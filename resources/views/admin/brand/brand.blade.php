                        ...
                        <tbody>
                            @foreach ($brands as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td><img src='{{ asset($item->image) }}' alt={{ $item->name }} width="50px"
                                            height="50px"></td>
                                    <td>
                                        ...
                                        <div class="form-group mt-2">
                                            <form action="{{ route('update.brands.status', $item->id) }}" method="POST"
                                                class="status-form">
                                                @csrf
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="p-2" href="{{ route('delete.brand', $item->id) }}">
                                ...
                                <div class="modal fade" id="edit-category{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update.brands', $item->id) }}" method="post"
    ...
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('post.brands') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="categoryname" class="col-form-label">Name:</label>
