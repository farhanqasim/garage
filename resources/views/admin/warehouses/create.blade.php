...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>Create a new warehouse for a branch</h6>
        </div>
        <div class="page-btn">
            ...
            <form action="{{ route('warehouses.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @enderror
                        @if($branches->count() === 0)
                            <small class="text-warning">All active branches already have warehouses. <a href="{{ route('all.branches') }}">Create a new branch first</a>.</small>
                        @endif
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="warehouse_code" class="form-control @error('warehouse_code') is-invalid @enderror" 
                               value="{{ old('warehouse_code') }}" placeholder="Auto-generated if left empty">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="notes" class="form-control" rows="3" 
                                  placeholder="Optional notes about this warehouse">{{ old('notes') }}</textarea>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-check me-1"></i> Create Warehouse
                    </button>
                </div>
            </form>
        </div>
