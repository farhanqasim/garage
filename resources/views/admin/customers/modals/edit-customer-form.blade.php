        ...
        <div class="row g-3 p-3">
            ...
            <div class="col-md-6">
                ...
                @if($customer->visiting_doc)
                    <div class="mt-2">
                        <a href="{{ asset($customer->visiting_doc) }}" target="_blank" class="btn btn-sm btn-outline-primary">View Current Document</a>
                    </div>
                @endif
            ...
            <div class="col-md-6">
                ...
                <div class="profile-upload-box text-center border rounded p-3 bg-light position-relative" style="cursor: pointer;">
                    ...
                    <div class="preview-container">
                        <img id="profile_preview" src="{{ $customer->profile_img ? asset($customer->profile_img) : '' }}" alt="Profile Preview" class="img-fluid rounded" style="max-height: 200px; {{ $customer->profile_img ? '' : 'display: none;' }}">
                    </div>
                    <div class="upload-placeholder {{ $customer->profile_img ? 'd-none' : '' }}">
                ...
                @if($customer->profile_img)
                    <div class="mt-2">
                        <a href="{{ asset($customer->profile_img) }}" target="_blank" class="btn btn-sm btn-outline-primary">View Current Image</a>
                    </div>
                @endif
            </div>
                        ...
                        <div class="row g-3 mb-3 align-items-end name-phone-row" data-index="{{ $index }}">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-danger remove-row" style="display:{{ count($customer->names) > 1 ? 'block' : 'none' }};">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="phones[]" value="{{ $customer->phones[$index] ?? '' }}" class="form-control" placeholder="Enter phone number">
                            </div>
                        </div>
                    @empty
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <select class="form-control" name="carnumber" id="carnumber">
                        ...
                        <option value="1" {{ $customer->carnumber == 1 ? 'selected' : '' }}>Vehicle One</option>
                    </select>
            ...
            <div class="col-md-6">
                ...
                <input type="number" step="0.01" name="opening_balance" value="{{ old('opening_balance', $customer->opening_balance) }}" class="form-control">
            </div>
            <div class="col-md-6">
                <label for="as_of_date" class="form-label">As of Date</label>
                <input type="text" name="as_of_date" id="as_of_date" class="form-control" placeholder="DD/MM/YYYY" value="{{ old('as_of_date', $customer->as_of_date_formatted ?? '') }}">
            </div>
            <div class="col-md-6">
                <label class="form-label">Balance Type</label>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="balance_type" value="receive" {{ ($customer->balance_type ?? 'receive') == 'receive' ? 'checked' : '' }}>
                    <label class="form-check-label">To Receive</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="balance_type" value="pay" {{ ($customer->balance_type ?? '') == 'pay' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                ...
                <div id="creditLimitOptions" style="display: {{ ($customer->credit_limit_type ?? 'no_limit') !== 'no_limit' ? 'block' : 'none' }};">
                    <div id="custom_limit_input" class="ms-4 mt-2">
                        <input type="number" step="0.01" name="credit_limit" value="{{ old('credit_limit', $customer->credit_limit) }}" class="form-control" placeholder="Enter credit limit">
                    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="multiple-upload-box text-center border rounded p-3 bg-light position-relative" style="cursor: pointer; min-height: 200px;">
                    ...
                    <div class="upload-placeholder {{ !empty($customer->multiple_images) ? 'd-none' : '' }}">
