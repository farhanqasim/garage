										...
										<ul class="tabs owl-carousel pos-category5">
											<li id="all" class="active">
												<a href="javascript:void(0);" class="category-filter" data-category="all">
													<img src="{{ asset('assets/img/products/pos-product-01.png') }}" alt="All Categories">
												</a>
												<h6><a href="javascript:void(0);" class="category-filter" data-category="all">All</a></h6>
											</li>
											@foreach($categories as $category)
											<li id="category-{{ $category->id }}">
												<a href="javascript:void(0);" class="category-filter" data-category="{{ $category->id }}">
													<img src="{{ asset('assets/img/products/pos-product-01.png') }}" alt="{{ $category->name }}">
												</a>
												<h6><a href="javascript:void(0);" class="category-filter" data-category="{{ $category->id }}">{{ $category->name }}</a></h6>
											</li>
											@endforeach
										</ul>
									</div>
										...
										<div class="d-flex align-items-center justify-content-between flex-wrap mb-2">
											...
											<div class="d-flex align-items-center flex-wrap mb-2">
												<div class="input-icon-start search-pos position-relative mb-2 me-3">
													...
													<input type="text" class="form-control" id="product-search" placeholder="Search by name or barcode" autocomplete="off">
												</div>
												<a href="{{ route('pos.index') }}" class="btn btn-sm btn-dark mb-2 me-2"><i class="ti ti-refresh me-1"></i>Reset</a>
											</div>
										</div>
										<div class="pos-products">
											<div class="tabs_container">
												<div class="tab_content active" data-tab="all" id="products-container">
													<div class="row g-3" id="products-grid">
														@forelse($items as $item)
														@php
															$itemName = $item->short_disc ?? $item->pro_dis ?? ($item->partnumber_item->name ?? $item->bar_code);
														@endphp
														<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
															<div class="product-info card mb-0 add-to-cart-item" 
																 data-id="{{ $item->id }}"
																 data-name="{{ $itemName }}"
																 data-price="{{ $item->sale_price ?? $item->price_per_unit ?? 0 }}"
																...
																<h6 class="cat-name">
																	<a href="javascript:void(0);">{{ $item->category->name ?? 'Uncategorized' }}</a>
																</h6>
																<h6 class="product-name"><a href="javascript:void(0);">{{ $itemName }}</a></h6>
																<div class="d-flex align-items-center justify-content-between price">
																	<div>
																		<p class="text-gray-9 mb-0">Rs. {{ number_format($item->sale_price ?? $item->price_per_unit ?? 0, 2) }}</p>
																		<small class="text-muted">Stock: {{ $item->on_hand ?? 0 }}</small>
																	</div>
												...
												<!-- Old category tabs removed - using dynamic filtering now -->
												<div style="display:none;" class="tab_content" data-tab="headphones">
													<div class="row g-3">
														<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3">
...
$(document).ready(function() {
    ...
    function performSearch(term) {
        const category = $('.tabs .active').find('a').data('category') || 'all';
        const url = new URL('{{ route("pos.index") }}', window.location.origin);
    ...
    $('.add-to-cart-btn').on('click', function(e) {
        ...
        const item = $(this).closest('.add-to-cart-item');
        const itemData = {
            id: item.data('id'),
            name: item.data('name'),
        ...
        // Here you can add the item to cart
        // For now, just show an alert
        console.log('Add to cart:', itemData);
        // TODO: Implement cart functionality
        alert('Added ' + itemData.name + ' to cart!');
    });
});
</script>
@endpush
