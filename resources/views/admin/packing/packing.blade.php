@extends('layouts.app')
@section('title', __('Packings List'))
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h2 class="fw-bold">Packings</h2>
                </div>
            </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table id="searchableTable" class="table table-hover table-center " id="categoryTable">
                        ...
                        <tbody>
                            @foreach ($packings as $index => $item)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td>
                                        ...
                                        <div class="form-group mt-2">
                                            <form action="{{ route('update.packings.status', $item->id) }}" method="POST"
                                                class="status-form">
                                                @csrf
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="p-2" href="{{ route('delete.packings', $item->id) }}">
                                ...
                                <div class="modal fade" id="edit-category{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update.packings', $item->id) }}" method="post"
    ...
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('post.packings') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="categoryname" class="col-form-label">Name:</label>
