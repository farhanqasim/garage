@extends('layouts.app')
@section('title', __('Platos List'))
@section('content')
    <div class="content">
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h2 class="fw-bold">Platos</h2>
                </div>
            </div>
        ...
        <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group mt-2">
                                            <form action="{{ route('update.platos.status', $item->id) }}" method="POST"
                                                class="status-form">
                                                @csrf
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            ...
                                            <a class="p-2" href="{{ route('delete.platos', $item->id) }}">
                                ...
                                <div class="modal fade" id="edit-category{{ $item->id }}">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('update.platos', $item->id) }}" method="post"
            ...
            <div class="card-footer">
                <div class="">
                    {{ $platos->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('post.platos') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="categoryname" class="col-form-label">Name:</label>
